...
def main():
    ...
    leverroot = os.path.abspath(os.path.join(project_top, 'lever'))
    ...
    config.set('DEFAULT', 'leverroot', leverroot)
    ...
    try:
        ...
        output_dir = '%s/lua-bindings/auto' % project_root

        cmd_args = {'lever_visible_button.ini' : ('lever_visible_button', 'lua_lever_visible_button_auto') }
        #cmd_args = {'lever_ext.ini' : ('lever_ext', 'lua_lever_ext_auto')}
