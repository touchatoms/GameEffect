...
function Pentagon:_initBody()
    self._sprite = display.newSprite("pentagon.png")
    ...
    print("pentagon", self._options._size.width, self._options._size.height)
    ...
    local velocity = cc.p((math.random() - 0.5) * 100, (math.random() - 0.5) * 100)
...
function Pentagon:_initBgClick()
    local btn = self.app_:createView("ui.CCUIButton", {
        bg = {"pentagon.png", "pentagon.png", "pentagon.png"},
        click = function()
